<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="LygTallyNBW.News.List" %>
<!DOCTYPE html>
<html lang="en">
	<head  runat="server">
    	<meta charset="utf-8">
		...
		<div class="row">
            ...
            <!--#include file="../frame/left.html"-->
                ...
                <div class="main">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-file-text"></i> <%=Title %></h3>
                        </div>
                    </div>
                    <!-- 公司新闻 -->
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h2><i class="fa fa-flag-o red"></i><strong> <%=Title %></strong></h2>
                                    ...
                                    <div class="panel-body">
                                        <table class="table bootstrap-datatable countries" >
                                            ...
                                            <ItemTemplate>
                                                <tr><td align="left"><a href ='Detail.aspx?id=<%# DataBinder.Eval(Container, "DataItem.id")%>' target ="_blank" ><%# DataBinder.Eval(Container, "DataItem.topic")%></a></td><td align="right"><%# Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.post_time")).ToString("yyyy-MM-dd") %></td></tr>
                                            </ItemTemplate>
