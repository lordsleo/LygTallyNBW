<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="LygTallyNBW.Contact.Contact" %>
            ...
            <div class="container-fluid content">
                <div class="row">
                    ...
                    <div class="main">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="fa fa-file-text"></i>电话查询</h3>
                            </div>
                        </div>
                        <!-- 集装箱船舶 -->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">
                                        <i class="fa fa-flag-o red"></i><strong>人员列表</strong>
                                    </label>
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                                <div class="input-group">
                                                    <span class="input-group-addon">按姓名查找</span>
                                                    <asp:TextBox ID="name" class="form-control" placeholder="请输入船名" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4">
                                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="查找" UseSubmitBehavior="false" class="btn btn-primary" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table bootstrap-datatable countries">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-priority="2">手机号</th>
                                                <th data-priority="3">手机短号</th>
                                                <th data-priority="4">所属部门</th>
                                            </tr>
                                        </thead>
                                        <tbody>
