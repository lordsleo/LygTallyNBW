<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DutyFreeShip.aspx.cs" Inherits="LygTallyNBW.Business.DutyFreeShip" %>
            ...
            <div class="container-fluid content">
                <div class="row">
                    ...
                    <div class="main">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="fa fa-file-text"></i>免税船舶</h3>
                            </div>
                        </div>
                        <!-- 集装箱船舶 -->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">
                                        <i class="fa fa-flag-o red"></i><strong>到港时间</strong>
                                    </label>
