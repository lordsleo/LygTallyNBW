<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConCheck.aspx.cs" Inherits="LygTallyNBW.Business.ConCheck" %>
            ...
            <div class="container-fluid content">
                <div class="row">
                    ...
                    <div class="main">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="fa fa-file-text"></i>集装箱离境核查</h3>
                            </div>
                        </div>
                        <!-- 集装箱船舶 -->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">
                                        <i class="fa fa-flag-o red"></i><strong>理货时间</strong>
                                    </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div class="input-group">
                                                    ...
                                                    <asp:TextBox ID="con_no"  class="form-control" placeholder="请输入箱号" runat="server" ></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2">
                                            ...
                                            <%--<div class="col-lg-2 col-md-2">
                                                <div class="input-group">
                                                    ...
                                                    <asp:TextBox ID="blno"  class="form-control" placeholder="请输入提单号" runat="server" ></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2">
                                                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click1" Text="查询" UseSubmitBehavior="false" class="btn btn-primary" />
                                            </div>--%>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table bootstrap-datatable countries">
                                        <thead>
                                            <tr>									
                                                ...
                                                <th data-priority="2">箱号</th>
                                                <th data-priority="3">IMO号</th>
                                                <th data-priority="4">船名/航次</th>
                                                <th data-priority="10">理货时间</th>
                                                <th data-priority="11">作业地点</th>
                                                <th data-priority="10">卸货港</th>
                                                <th data-priority="11">提单号</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <asp:Repeater ID="mscb" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        <th><%# Convert.ToInt16(DataBinder.Eval(Container, "ItemIndex"))+1%></th>
