<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BoatSelect.aspx.cs" Inherits="LygTallyNBW.Business.BoatSelect" %>
            ...
            <div class="container-fluid content">
                <div class="row">
                    ...
                    <div class="main">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="fa fa-file-text"></i>船舶查询</h3>
                            </div>
                        </div>
                        <!-- 集装箱船舶 -->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">
                                        <i class="fa fa-flag-o red"></i><strong>船舶列表</strong>
                                    </label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <asp:TextBox ID="shipname"  class="form-control" placeholder="请输入船名" runat="server" ></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4">
                                    ...
                                    <table class="table bootstrap-datatable countries">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-priority="10">到港时间</th>
                                                <th data-priority="11">船代公司</th>
                                            </tr>
                                        </thead>
                                        <tbody>
