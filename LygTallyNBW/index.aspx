<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="LygTallyNBW.index" %>
    ...
    <div class="container-fluid content">
        ...
        <div class="row">
            ...
            <div class="main">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-laptop"></i>今日要闻</h3>
                    </div>
                </div>
                <div class="row">
                    <!-- 公司新闻 -->
                    <div class="col-lg-6 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h2><i class="fa fa-flag-o red"></i><strong>公司新闻</strong></h2>
                                ...
                                <table class="table bootstrap-datatable countries">
                                    <tbody>
                                        <asp:Repeater ID="CompanyNews" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="left"><a href='News/Detail.aspx?id=<%# DataBinder.Eval(Container, "DataItem.id")%>' target="_blank"><%# DataBinder.Eval(Container, "DataItem.topic")%></a></td>
                                                    <td align="right"><%# Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.post_time")).ToString("yyyy-MM-dd") %></td>
                                                </tr>
                                            </ItemTemplate>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h2><i class="fa fa-flag-o red"></i><strong>通知公告</strong></h2>
                                <div class="panel-actions">
                                </div>
                            </div>
                            <div class="panel-body">
                                <table class="table bootstrap-datatable countries">
                                    <tbody>
                                        <asp:Repeater ID="Notices" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="left"><a href='News/Detail.aspx?id=<%# DataBinder.Eval(Container, "DataItem.id")%>' target="_blank"><%# DataBinder.Eval(Container, "DataItem.topic")%></a></td>
                                                    <td align="right"><%# Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.post_time")).ToString("yyyy-MM-dd") %></td>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h2><i class="fa fa-flag-o red"></i><strong>学习资料</strong></h2>
                                <div class="panel-actions">
                                </div>
                            </div>
                            <div class="panel-body">
                                <table class="table bootstrap-datatable countries">
                                    <tbody>
                                        <asp:Repeater ID="Study" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="left"><a href='News/Detail.aspx?id=<%# DataBinder.Eval(Container, "DataItem.id")%>' target="_blank"><%# DataBinder.Eval(Container, "DataItem.topic")%></a></td>
                                                    <td align="right"><%# Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.post_time")).ToString("yyyy-MM-dd") %></td>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h2><i class="fa fa-flag-o red"></i><strong>安全警示</strong></h2>
                                <div class="panel-actions">
                                </div>
                            </div>
                            <div class="panel-body">
                                <table class="table bootstrap-datatable countries">
                                    <tbody>
                                        <asp:Repeater ID="Safe" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td align="left"><a href='News/Detail.aspx?id=<%# DataBinder.Eval(Container, "DataItem.id")%>' target="_blank"><%# DataBinder.Eval(Container, "DataItem.topic")%></a></td>
                                                    <td align="right"><%# Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.post_time")).ToString("yyyy-MM-dd") %></td>
